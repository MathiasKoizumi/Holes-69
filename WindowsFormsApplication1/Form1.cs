...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		private string[] resourse = new string[14];
		...
		private void unpackSound()
		{
			...
			Stream manifestResourceStream2 = GetType().Assembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Effects.93846__cgeffex__huge-explosion6.wav");
			if (!File.Exists("136702__hoscalegeek__laser-zap.wav"))
			{
				using (Stream output2 = File.Create("136702__hoscalegeek__laser-zap.wav"))
				{
		...
		public void playMP3()
		{
			...
			wplayer.URL = resourse[junkie.Next(14)];
		...
		public void flyBy()
		{
			...
			Assembly executingAssembly = Assembly.GetExecutingAssembly();
			Stream manifestResourceStream = executingAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.invader.png");
			Image image = Image.FromStream(manifestResourceStream);
			Point point = new Point(junkie.Next(1400), junkie.Next(800));
			Bitmap image2 = new Bitmap(bitmap.Width, bitmap.Height);
			Size size = new Size(image.Width, image.Height);
			for (int i = 0; i < junkie.Next(25, 50); i++)
			{
				switch (junkie.Next(4))
				{
				case 0:
					point.X += junkie.Next(115);
					break;
				case 1:
					point.X -= junkie.Next(115);
					break;
				case 2:
					point.Y += junkie.Next(115);
					break;
				case 3:
					point.Y -= junkie.Next(115);
					break;
				...
				case 1:
				{
					int num2 = junkie.Next(100);
					size.Width = Math.Abs(size.Width - num2);
					size.Height = Math.Abs(size.Height - num2);
					break;
				}
				case 0:
				{
					int num = junkie.Next(100);
					size.Width += num;
					size.Height += num;
					break;
				}
		...
		public void dropDownMyHoney()
		{
			...
			Size size3 = new Size(image3.Width, image3.Height);
			Size size4 = new Size(image4.Width, image4.Height);
			Size size5 = new Size(image5.Width, image5.Height);
			for (int i = 0; i < junkie.Next(35, 60); i++)
			{
				if (junkie.Next(1) == 0)
				{
					point.Y += junkie.Next(28);
					point2.Y += junkie.Next(55);
					point3.Y += junkie.Next(169);
					point4.Y += junkie.Next(300);
					point5.Y += junkie.Next(40);
					point.X += junkie.Next(8);
					point2.X -= junkie.Next(15);
					point3.X += junkie.Next(69);
					point4.X -= junkie.Next(30);
					point5.X += junkie.Next(40);
				}
				int num = junkie.Next(10, 50);
				size.Width = Math.Abs(size.Width - num);
				size.Height = Math.Abs(size.Height - num);
				num = junkie.Next(10, 15);
				size2.Width += num;
				size2.Height += num;
				num = junkie.Next(5, 25);
				size3.Width = Math.Abs(size3.Width - num);
				size3.Height = Math.Abs(size3.Height - num);
				num = junkie.Next(2, 200);
				size4.Width += num;
				size4.Height += num;
				num = junkie.Next(1, 2);
				size5.Width += num;
